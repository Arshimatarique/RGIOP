...
<h2 style="color:#ffffff;">Parent's Login</h2>
<ul>
        ...
        <div class="mid-cls">
            ...
            <div class="main">
                        ...
                        <div class="form-left-to-w3l">
                            ...
                            <select name="select[]" style="padding:8px;margin-top: 10px;margin-bottom: 10px; color: #000000; width:50%;">
                            ...
                            <option value="Electronics &amp; Telecommunication Engg.">Electronics &amp; Telecommunication Engg.</option>
...
<br>
<div class="btnn">
                <button type="submit" class="btn btn-default" name="submit" >Submit and continue</button><br>
                <div class="clear"></div>
            </div>      
