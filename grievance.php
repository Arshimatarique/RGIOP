...
<h2 style="color:#ffffff;">Grievance Redressal</h2>
<ul>
...
<br>
      <div class="about-w3">
                <div class="container">
                  <!--   <h2 class="tittle">Grievance</h2> -->
                    <div class="about-grids">
                        <div class="col-md-12 about-grid">
                         <center><h4>GRIEVANCE REDRESSAL PORTAL</h4></center> 
                         <hr/>
...
<br>
                               <center> <button type="submit" class="btn btn-default">Send</button>
                                <button type="reset" class="btn btn-default">Clear</button></center>
                              </form>


                         </div>
                        <!--  <div class="col-md-5 video-grid">
                            <br><br><br><br>
                       <img src="images\PLEASE.jpg" height="1200px" class="img-responsive">
                        </div> -->
