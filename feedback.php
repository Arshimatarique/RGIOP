...
<br><br>
		  ...
		  <div class="art-bothside" align="center">
        <div class="Up-sign-form text-center">
        <h2>Feedback For College</h2>
        <p>We value and appreciate your compliments and suggestions.</p>
        </div><hr>
        <br>

        <div class="mid-cls" align="center">
        
                
                <a href="studentlogin.php" class="button pink"><font size="4">Student</font></a>
    
                <a href="alumnilogin.php" class="button blue"><font size="4">Alumni</font></a>
                
                <a href="employerlogin.php" class="button green"><font size="4">Employer</font></a>
                
                <a href="teacherlogin.php" class="button orange"><font size="4">Teacher</font></a>
                
                <a href="parentslogin.php" class="button purple"><font size="4">Parents</font></a>
